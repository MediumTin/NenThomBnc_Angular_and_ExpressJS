This source is a combined program for e-Commercial website with MEAN stack

1. Backend will be supported by ExpressJS
2. Frontend will be supported by Angular
3. AI Service will be supported by FastAPI
