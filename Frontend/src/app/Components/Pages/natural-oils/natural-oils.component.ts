...
@Component({
  selector: 'app-natural-oils',
standalone: true,
  imports: [RouterOutlet, JsonPipe, HttpClientModule, CommonModule, RouterModule],
  templateUrl: './natural-oils.component.html',
  styleUrl: './natural-oils.component.css'
})
export class NaturalOilsComponent implements OnInit, AfterViewInit {
  candles: Candles[] = [];
