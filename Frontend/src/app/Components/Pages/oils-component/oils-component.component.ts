...
@Component({
  selector: 'app-oils-component',
  standalone: true,
  imports: [RouterOutlet, JsonPipe, HttpClientModule, CommonModule, RouterModule],
  templateUrl: './oils-component.component.html',
  styleUrl: './oils-component.component.css',
})
export class OilsComponentComponent implements OnInit, AfterViewInit {
  candles: Candles[] = [];
  ...
  ngAfterViewInit(): void  {  
    // this.loadProducts();
    this.setCheckboxValue('oil', true);
  }
  ngOnInit(): void {
