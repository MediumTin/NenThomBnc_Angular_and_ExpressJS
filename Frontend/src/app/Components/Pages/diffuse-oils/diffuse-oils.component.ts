...
@Component({
  selector: 'app-diffuse-oils',
standalone: true,
  imports: [RouterOutlet, JsonPipe, HttpClientModule, CommonModule, RouterModule],
  templateUrl: './diffuse-oils.component.html',
  styleUrl: './diffuse-oils.component.css'
})
export class DiffuseOilsComponent implements OnInit, AfterViewInit {
  candles: Candles[] = [];
  ...
  constructor(private router:Router, private candlesService : CandlesServiceService,activatedRoute: ActivatedRoute, private renderer:Renderer2,private identification: IndentificationService, private filteredProduct : FilteredProductService ) { 
